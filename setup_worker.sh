...
if [ "$UNAME" = "Darwin" ]; then
    ...
    uv pip install --python .venv torch pt-kmeans safetensors huggingface_hub pydantic pyyaml
    ...
    uv pip install --python .venv pt-kmeans safetensors huggingface_hub pydantic pyyaml
else
